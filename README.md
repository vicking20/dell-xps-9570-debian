...
Settings to double check, you can go to 'steam > settings > compatibility' and select enable steam play for all other titles. 

![Screenshot from 2024-07-29 15-53-15](https://github.com/user-attachments/assets/ce5bc86d-333d-490d-8b0e-6539bb5befd8)

![Screenshot from 2024-07-29 15-56-28](https://github.com/user-attachments/assets/d833a6fe-0aa2-4a14-8cb2-22a84f04278d)

You will need to restart steam to get this done, but you can select restart later for now, and you should see the option 'run other titles with: proton experimental will be there by default, but may not work for all games, especially if you would like to run some windows exe games directly. In this case, you can tinker around with different proton versions, proton 8.0-5 should be fine, maybe proton 9 works fine also, but I have not tested it, I dont play so many games. Now you can select restart. Steam will restart and you can probably use it to run a few games.
...
In the search bar, type blur my shell, select it and install. 

![Screenshot from 2024-07-29 16-04-08](https://github.com/user-attachments/assets/ba8adf1a-3de1-48ad-96ab-398b63821f65)

Click open link and select install, This will give us a blurred look on gnome instantly, which is not much, but at least makes things a little bit nicer.

![Screenshot from 2024-07-29 16-04-27](https://github.com/user-attachments/assets/f15b6b95-1a36-4f81-8c60-8c5afa5d4a59)

Go back to the search section and search for 'hide top bar'
select it and install.

![Screenshot from 2024-07-29 16-06-13](https://github.com/user-attachments/assets/386c465e-9a98-47d7-9e9f-ff407e37b64a)
...
![Screenshot from 2024-07-29 16-07-08](https://github.com/user-attachments/assets/708b0eba-ab14-45a9-a80b-bfcbdcd34590)

![Screenshot from 2024-07-29 16-07-40](https://github.com/user-attachments/assets/ec83ce1e-664f-41cd-b2a8-3da35ea18c68)

![Screenshot from 2024-07-29 16-08-52](https://github.com/user-attachments/assets/d3311d55-7ce2-4602-80db-f3941af0775a)

![Screenshot from 2024-07-29 16-08-58](https://github.com/user-attachments/assets/0fd239e5-8faa-4b3e-946d-4bd70cc2581c)
...
![Screenshot from 2024-07-29 16-10-25](https://github.com/user-attachments/assets/9ad320a5-6431-4c90-8e3f-1f345fd67214)

![Screenshot from 2024-07-29 16-11-03](https://github.com/user-attachments/assets/b310a4c9-1706-4050-bfe4-52f5111a327d)
...
To enable proper touch scroll function in firefox, we need to edit a file, simply open the terminal, and use the commands sudo nano /etc/security/pam_env.conf 

![Screenshot from 2024-07-29 23-18-30](https://github.com/user-attachments/assets/d1445779-ff1b-4892-be27-c64987f83bff)

press enter and in the file opened under nano, go to the bottom of the file and add this line MOZ_USE_XINPUT2 DEFAULT=1

![Screenshot from 2024-07-29 23-19-28](https://github.com/user-attachments/assets/85edfe32-9b48-4c0d-9aea-2014957ee096)
